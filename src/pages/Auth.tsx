  ...
  return (
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 gradient-primary flex-col items-center justify-center p-12 relative overflow-hidden">
        ...
        <div
          className="absolute bottom-32 left-20 bg-white/10 rounded-xl p-3 animate-bounce-slow"
          style={{ animationDelay: "0.5s" }}
        >
          <BarChart3 className="w-6 h-6 text-white/80" />
        </div>
        <div
          className="absolute top-1/3 left-16 bg-white/10 rounded-xl p-3 animate-bounce-slow"
        ...
        <div className="relative z-10 flex flex-col items-center text-center max-w-md">
          ...
          <Link to="/privacy" className="text-sm text-white/70 hover:text-white underline transition-colors">
